...
import '../../../views/add_property/model/options.dart';
...
class PropertyFeaturesDetails extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Selector<AddPropertyProvider, List<DbPropertyType>>(
      shouldRebuild: (prev, next) => true,
      selector: (_, state) => state.propertyTypeList,
      builder: (_, propertyList, __) {
        final _selectedPropertyType = provider.propertyTypeList
            .firstWhereOrNull((element) => element.isSelected);
        if (_selectedPropertyType != null) {
          return Column(
            children: [
              if (CommonPropertyDataProvider.checkForBuildingType(
                  [_selectedPropertyType.id]))
                _buildingTypeWidget(context),
              if (CommonPropertyDataProvider.checkForConstruction(
                  [_selectedPropertyType.id]))
                _constructionWidget(context),
              if (CommonPropertyDataProvider.isNotPlotOrLandMark(
                  [_selectedPropertyType.id]))
              ...
              if (CommonPropertyDataProvider.checkForBhk(
                  [_selectedPropertyType.id]))
                _bhkWidget(),
              if (CommonPropertyDataProvider.checkForConnectedRoad(
                  [_selectedPropertyType.id]))
                _connectedRoadsWidget(context),
              if (CommonPropertyDataProvider.checkForBathRoom(
                  [_selectedPropertyType.id]))
                _bathRoomWidget(),
              if (CommonPropertyDataProvider.checkForRoom(
                  [_selectedPropertyType.id]))
                _roomsWidget(),
              if (CommonPropertyDataProvider.checkForWashRoomAvailable(
                  [_selectedPropertyType.id]))
                _washroomWidget(context),
              if (CommonPropertyDataProvider.isNotPlotOrLandMark(
                  [_selectedPropertyType.id]))
                _balconyWidget(context),
              if (CommonPropertyDataProvider.checkForCornerPiece(
                  [_selectedPropertyType.id]))
                _cornerPieceWidget(context),
              if (CommonPropertyDataProvider.checkForLightConnection(
                  [_selectedPropertyType.id]))
                _lightConnectionWidget(context),
              if (CommonPropertyDataProvider.checkForWellAvailable(
                  [_selectedPropertyType.id]))
                _wellWidget(context),
              if (CommonPropertyDataProvider.checkForAllottedParkingAvailable(
                  [_selectedPropertyType.id]))
                _allottedParkingWidget(context),
              if (CommonPropertyDataProvider.checkForParkingAvailable(
                  [_selectedPropertyType.id]))
                _parkingWidget(context),
              if (CommonPropertyDataProvider.checkForLiftAvailable(
                  [_selectedPropertyType.id]))
                _liftWidget(context),
              if (CommonPropertyDataProvider.checkForFloor(
                  [_selectedPropertyType.id]))
                _floorWidget(),
              if (CommonPropertyDataProvider.checkForTotalFloor(
                  [_selectedPropertyType.id]))
                _totalFloorWidget(),
              if (CommonPropertyDataProvider.checkForScheme(
                  [_selectedPropertyType.id]))
                _schemeWidget(context),
              if (CommonPropertyDataProvider.checkForFacingType(
                  [_selectedPropertyType.id]))
                _facingWidget(),
          ...
          /*return Container(
            ...
            margin: EdgeInsets.only(
              top: Dimensions.expandableChildrenPadding.h,
            ),
            child: Text(
              localizationsContext.selectAnyPropertyType,
              style: TextStyle(
                fontSize: Dimensions.propertyEmptyFeatureTextSize.sp,
  ...
  _washroomWidget(BuildContext context) {
    provider.updateBasicPropertyDetailsKeys(
    ...
    return Column(
      ...
      children: [
        ...
        Selector<AddPropertyProvider, Tuple2<List<Options>, bool?>>(
  ...
  _balconyWidget(BuildContext context) {
    provider.updateBasicPropertyDetailsKeys(localizationsContext.balcony);
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      mainAxisSize: MainAxisSize.max,
      children: [
  ...
  _cornerPieceWidget(BuildContext context) {
    provider.updateBasicPropertyDetailsKeys(localizationsContext.cornerPiece);
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      mainAxisSize: MainAxisSize.max,
      children: [
  ...
  _wellWidget(BuildContext context) {
    provider.updateBasicPropertyDetailsKeys(localizationsContext.wellAvailable);
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      mainAxisSize: MainAxisSize.max,
      children: [
  ...
  _furnishedWidget(BuildContext context) {
    provider
        .updateBasicPropertyDetailsKeys(localizationsContext.furnishedStatus);
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      mainAxisSize: MainAxisSize.max,
      children: [
        ...
        Selector<AddPropertyProvider, List<DbPropertyFurnishedStatus>>(
          selector: (_, state) => state.furnishedStatusList,
          shouldRebuild: (prev, next) => true,
  ...
  _buildingTypeWidget(BuildContext context) {
    provider.updateBasicPropertyDetailsKeys(localizationsContext.buildingType);
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      mainAxisSize: MainAxisSize.max,
      children: [
        ...
        Selector<AddPropertyProvider, List<DbPropertyBuildingType>>(
            ...
            return GridView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return CheckboxRadioItem(
                  ...
                  isSingleSelection: true,
                  onSelect: (value) => provider.selectBuildingType(value),
                );
              },
            );
          },
  ...
  _constructionWidget(BuildContext context) {
    provider.updateBasicPropertyDetailsKeys(localizationsContext.construction);
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      mainAxisSize: MainAxisSize.max,
      children: [
        ...
        Selector<AddPropertyProvider, List<DbPropertyConstructionType>>(
  ...
  _schemeWidget(BuildContext context) {
    provider.updateBasicPropertyDetailsKeys(localizationsContext.scheme);
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      mainAxisSize: MainAxisSize.max,
      children: [
        ...
        Selector<AddPropertyProvider, List<DbPropertySchemeType>>(
  ...
  _additionalFurnishingWidget() {
    ...
    return Selector<AddPropertyProvider, List<DbAdditionalFurnish>>(
  ...
  _frontSizeWidget(BuildContext context) {
    final label = localizationsContext.frontSize;
    provider.updateBasicPropertyDetailsKeys(label);
    return SizedBox(
      height: Dimensions.addPropertyFieldsDefaultHeight.h,
      child: Stack(
        children: [
          Selector<AddPropertyProvider, TextEditingController>(
            shouldRebuild: (prev, next) => true,
            selector: (_, state) => state.propertyFrontSizeController,
  ...
  _depthSizeWidget(BuildContext context) {
    ...
    return SizedBox(
      ...
      child: Stack(
        children: [
          Selector<AddPropertyProvider, TextEditingController>(
            shouldRebuild: (prev, next) => true,
            selector: (_, state) => state.propertyDepthSizeController,
            builder: (context, controller, child) {
              return TextFieldWidget(
                label: label,
                hint: localizationsContext.enterSize,
  ...
  _facingWidget() {
    provider.updateBasicPropertyDetailsKeys(localizationsContext.facingType);
    return Selector<AddPropertyProvider, List<DbPropertyFacingType>>(
  ...
  _bhkWidget() {
    provider.updateBasicPropertyDetailsKeys(localizationsContext.bhk);
    return Selector<AddPropertyProvider, List<DbPropertyBhkType>>(
            ...
            GridView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return CheckboxRadioItem(
                  ...
                  isSingleSelection: true,
                  selectedId: selectedId,
                  onSelect: (selected) => provider.selectBhkType(
                    selected,
                    isUserTapped: true,
                  ),
                );
  ...
  /*_connectedRoadWidget() {
    provider.updateBasicPropertyDetailsKeys(localizationsContext.connectedRoad);
    return Selector<AddPropertyProvider, List<DbPropertyConnectedRoad>>(
      selector: (_, state) => state.connectedRoadList,
      shouldRebuild: (prev, next) => true,
      builder: (context, list, child) {
        return Column(
          mainAxisSize: MainAxisSize.min,
          ...
          children: [
            ...
            GridView.builder(
              ...
              itemCount: list.length,
              gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                crossAxisCount: Dimensions.connectedRoadCountPerLine,
                crossAxisSpacing: Dimensions.checkBoxRadioBoxBetweenSpacing.h,
                mainAxisSpacing: Dimensions.checkBoxRadioBoxBetweenSpacing.h,
                childAspectRatio: (Dimensions.checkBoxRadioBoxAspectRatioWidth /
                    Dimensions.connectedRoadAspectRatioHeight),
              ),
              itemBuilder: (context, index) {
                final selectedId = list
                        .firstWhereOrNull((element) => element.isSelected)
                ...
                return CheckboxRadioItem(
                  ...
                  isSelected: list[index].isSelected,
                  selectedId: selectedId,
                  onSelect: (selected) => provider.selectConnectedRoad(
  ...
  _bathRoomWidget() {
    final label = localizationsContext.bathRooms;
    provider.updateBasicPropertyDetailsKeys(label);
    return Column(
      children: [
        SizedBox(
        ...
        IncrementalItem(
          ...
          controller: provider.propertyBathRoomsController,
          ignoring: false,
          onValueChanged: (value) {
            if (value == 0) {
              provider.propertyBathRoomsController.text = '';
            } else {
              provider.propertyBathRoomsController.text = value.toString();
              StaticFunctions.fieldCursorPositionAtLast(
                provider.propertyBathRoomsController,
              );
            }
  ...
  _roomsWidget() {
    final label = localizationsContext.rooms;
    provider.updateBasicPropertyDetailsKeys(label);
    return Column(
      children: [
        SizedBox(
        ...
        IncrementalItem(
          ...
          controller: provider.propertyRoomsController,
          ignoring: false,
          onValueChanged: (value) {
            if (value == 0) {
              provider.propertyRoomsController.text = '';
            } else {
              provider.propertyRoomsController.text = value.toString();
              StaticFunctions.fieldCursorPositionAtLast(
                provider.propertyRoomsController,
              );
            }
            provider.updatePropertyDetails(
              label,
  ...
  _floorWidget() {
    final label = localizationsContext.floors;
    provider.updateBasicPropertyDetailsKeys(label);
    return Column(
      children: [
        SizedBox(
        ...
        IncrementalItem(
          ...
          controller: provider.propertyFloorsController,
          ignoring: false,
          onValueChanged: (value) {
            if (value == 0) {
              provider.propertyFloorsController.text = '';
            } else {
              provider.propertyFloorsController.text = value.toString();
              StaticFunctions.fieldCursorPositionAtLast(
                provider.propertyFloorsController,
              );
            }
            provider.updatePropertyDetails(
              label,
  ...
  _totalFloorWidget() {
    final label = localizationsContext.totalFloors;
    provider.updateBasicPropertyDetailsKeys(label);
    return Column(
      children: [
        SizedBox(
        ...
        IncrementalItem(
          ...
          controller: provider.propertyTotalFloorsController,
          ignoring: false,
          onValueChanged: (value) {
            if (value == 0) {
              provider.propertyTotalFloorsController.text = '';
            } else {
              provider.propertyTotalFloorsController.text = value.toString();
              StaticFunctions.fieldCursorPositionAtLast(
                provider.propertyTotalFloorsController,
              );
            }
            provider.updatePropertyDetails(
              label,
  ...
  _amenitiesWidget(BuildContext context) {
    provider.updateBasicPropertyDetailsKeys(localizationsContext.amenities);
    return Selector<AddPropertyProvider, List<DbPropertyAmenity>>(
      selector: (_, state) => state.amenitiesList,
      shouldRebuild: (prev, next) => true,
      builder: (context, list, child) {
        if (list.isEmpty) {
          return const SizedBox();
  ...
  _connectedRoadsWidget(BuildContext context) {
    provider.updateBasicPropertyDetailsKeys(localizationsContext.connectedRoad);
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
            ...
            children: [
              ...
              Expanded(
                child: TextFieldWidget(
                  ...
                  onValueChanged: (int? currentIndex, String value) {
                    provider.updatePropertyDetails(
                        localizationsContext.connectedRoad, null);
                  },
                ),
              ),
            ],
