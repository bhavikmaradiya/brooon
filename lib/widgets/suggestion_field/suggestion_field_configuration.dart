...
class SuggestionFieldConfiguration {
  ...
  const SuggestionFieldConfiguration({
    this.controller,
    this.focusNode,
    this.suffixIconPath,
  ...
  /// Copies the [SuggestionFieldConfiguration] and only changes the specified properties
  SuggestionFieldConfiguration copyWith({
    ...
    return SuggestionFieldConfiguration(
      controller: controller ?? this.controller,
      focusNode: focusNode ?? this.focusNode,
      suffixIconPath: suffixIconPath ?? this.suffixIconPath,
      suffixIconColor: suffixIconColor ?? this.suffixIconColor,
      backgroundColor: backgroundColor ?? this.backgroundColor,
      onSuffixIconClick: onSuffixIconClick ?? this.onSuffixIconClick,
