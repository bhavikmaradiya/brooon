...
class SuggestionsField<T> extends StatefulWidget {
  ...
  @override
  _SuggestionsFieldState<T> createState() => _SuggestionsFieldState<T>();
}
...
class _SuggestionsFieldState<T> extends State<SuggestionsField<T>>
  ...
  void didChangeMetrics() {
    ...
    this._suggestionsBox!.onChangeMetrics(mounted);
  }
  ...
  Widget build(BuildContext context) {
    return CompositedTransformTarget(
      ...
      child: TextFieldWidget(
        ...
        hint: widget.textFieldConfiguration.placeholder,
        label: widget.textFieldConfiguration.label,
        autoFocus: widget.textFieldConfiguration.autofocus,
        suffixIconAssetPath: widget.textFieldConfiguration.suffixIconPath ?? '',
        suffixIconColor: widget.textFieldConfiguration.suffixIconColor,
        onSuffixIconClick: widget.textFieldConfiguration.onSuffixIconClick,
        keepLabelAlwaysOnTop: true,
        backgroundColor: widget.textFieldConfiguration.backgroundColor,
        textAlign: widget.textFieldConfiguration.textAlign,
        maxLength: widget.textFieldConfiguration.maxLength,
        inputFormatter: widget.textFieldConfiguration.inputFormatters,
