...
class CloseInquiry extends StatelessWidget {
...
class CloseInquiryBody extends StatefulWidget {
  final CommonPropertyDataProvider commonPropertyDataProvider;
  final AppLocalizations? localizationsContext;
  final Function(CloseDealModel)? onCloseDeal;
  final Function callToCloseConfirmationDialog;
  ...
  @override
  State<CloseInquiryBody> createState() => _CloseInquiryBodyState();
}

class _CloseInquiryBodyState extends State<CloseInquiryBody> {
    ...
    await showModalBottomSheet(
      ...
      builder: (dialogContext) {
        ...
        if (dealType == SaveDefaultData.propertyForSellId) {
          dealName = widget.localizationsContext!.bought;
          icon = Strings.iconBought;
                  ...
                  children: [
                    ...
                    Text(
                      widget.localizationsContext!
                          .closeInquiryConfirmationDialogMessage(dealName),
            ...
            ColoredBox(
              ...
              child: Padding(
                ...
                child: Row(
                  ...
                  children: [
                    Text(
                      widget.localizationsContext!.closeInquiryDialogTitle,
                      style: TextStyle(
                        fontWeight: FontWeight.w600,
                        fontSize: Dimensions.bottomSheetTitleTextSize.sp,
                        color: StaticFunctions.getColor(
                    ...
                    builder: (context, controller, child) {
                      return TextFieldWithDropdown(
                        ...
                        textFieldConfiguration: SuggestionFieldConfiguration(
                          ...
                          label: widget.localizationsContext!
                              .closeInquiryDialogSellerName,
                  ...
                  Selector<CloseDealDialogProvider, TextEditingController>(
                    ...
                    builder: (context, controller, child) {
                      return TextFieldWidget(
                        label: widget.localizationsContext!
                            .closeInquiryDialogSellerMobile,
                        hint: widget
                  ...
                  Selector<CloseDealDialogProvider, List<MatchingModel>>(
                    ...
                    builder: (context, list, child) {
                      ...
                      return Column(
                        ...
                        children: [
                          Text(
                            widget.localizationsContext!.selectProperty,
                            style: TextStyle(
                              fontSize: Dimensions
                          ...
                          return ButtonWidget(
                            ...
                            onClick: () async {
                              if (isValid) {
                                _closeDealProvider?.mounted = false;
                                Navigator.pop(context);
                                final sellerName = _closeDealProvider!
